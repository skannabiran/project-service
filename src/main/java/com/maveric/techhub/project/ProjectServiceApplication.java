package com.maveric.techhub.project;

import com.maveric.techhub.project.config.AppConstants;
import com.maveric.techhub.project.config.ApplicationProperties;
import com.maveric.techhub.project.config.DefaultProfileUtil;
...
public class ProjectServiceApplication {
	...
	public ProjectServiceApplication(Environment env) {
		this.env = env;
	}
	...
	public static void main(String[] args) throws UnknownHostException {
		SpringApplication app = new SpringApplication(ProjectServiceApplication.class);
